    ...
    // проверка на количество входящих переменных
      ...
      for (var i=0; i < courses.length; i++) {
        ...
        if ((priceFrom <= price[0] && priceTill >= price[0]) ||
            (priceFrom >= price[0] && priceFrom <= price[1])  ||
            (priceTill == null && (priceFrom >= price[0] && priceFrom <= price[1])) || 
            (price[1]==null && (priceFrom >= price[0] || priceTill >= price[0]))
